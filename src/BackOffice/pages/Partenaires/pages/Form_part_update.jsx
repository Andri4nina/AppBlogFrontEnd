...
const Form_part_update = () => {
    ...
    useEffect(() => {
        axios
            .get(`http://localhost:3000/partenaire/${partId}`)
            .then((res) => {
                setPartenaireData(res.data);
                setFormData({
                    nom_partenaire: res.data.nom_partenaire,
                    abbrev_partenaire: res.data.abbrev_partenaire,
                    histoire_partenaire: res.data.histoire_partenaire,
                    siteOff_partenaire:res.data.siteOff_partenaire,
                    logo_partenaire: res.data.logo_partenaire,
                    couv_partenaire: res.data.couv_partenaire,
                    type_partenaire: res.data.type_partenaire,
                });
            })
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios
            .put(`http://localhost:3000/partenaire/${partId}`, formData)
            .then((res) => {
...
export default Form_part_update
